...
childProcess.execSync(`npx babel src --out-dir src ${BABEL_OPTIONS}`);

console.info('## Build lib (native component) files - convert TS to JS files ##');
childProcess.execSync(`npx babel lib --out-dir lib ${BABEL_OPTIONS}`);

console.info('## Build main index file - for lazy load exports ##');
childProcess.execSync(`npx babel ./src/index.js -o ./src/index.js ${BABEL_INDEX_EXPORTS_OPTIONS}`);
